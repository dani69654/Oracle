...
contract OracleAuthority {
  ...
  modifier isBlacklisted(address _sender) {
    require(!_isBlacklisted(_sender), "Sender blacklisted");
    _;
  }
  ...
  function _isBlacklisted(address _sender) internal view returns (bool) {
